...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        <div>
            ...
            <a href="../index.php"> <img src="logo.png" style="height: 180px;" class="img-circle"></a>
        ...
        <p style="font-size: 18px">Login in. To see it in action.</p>
        <p>
            <?php
...
<!--            <a class="btn btn-sm btn-white btn-block" style="border-radius: 20px;" href="register.html">Create an account</a>-->
        ...
        <p class="m-t"> <small>Maxsom &copy; 2022</small> </p>
    </div>
</div>
