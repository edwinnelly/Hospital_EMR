                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Requested Patients Profile</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="user_dir.php"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item active">Requested Patients Profile</li>
                            </ul>
                        </div>
                                ...
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                            <td></td>
                                            <td></td>
                                            <td style="text-transform: capitalize">Hemoglobin A1C</td>
                                            <td>Hemoglobin A1C</td>
                                            <td></td>
                                            <td>07/04/22</td>
                                            <td>
                                                <button data-toggle="dropdown" class="btn btn-primary btn-sm ">Assign
                                                    Test
                                                </button>
                                            </td>
                                        </tr>
