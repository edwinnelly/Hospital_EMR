...
<head>
    ...
    <title>Lab Accounts | Controls</title>
            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        <h2>
                            <h4 class="font-weight-bold">Hospital  / Lab / Patients / Payments  <a href="add_patients"></a></h4>
                        </h2>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="lab_payments.php?aset=<?=  base64_encode($values->id);  ?>" class="dropdown-item font-weight-bold edit_asset" >Approve Payment</a></li>
