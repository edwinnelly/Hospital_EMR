...
$lab_list_dpt= $add_user->quee_user_test_app($hos_key);
            ...
            <div class="row">
                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <h2>
                            <h3 class="font-weight-">Import Patients Data / Csv / Excel</h3>
                        </h2>
                    ...
                    <div class="mail-box">
                        ...
                        <table class="table table-hover table-mail">
                            ...
                            <tr>
                                ...
                                <td>Csv / Excel</td>
                                <td><button class="btn btn-primary btn-rounded btn-outline btn-sm">Download</button></td>
                                <td><button class="btn btn-primary btn-rounded btn-outline btn-sm">Import</button></td>
                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <h2>
                            <h3 class="font-weight-">Import Test Samples Data / Csv / Excel</h3>
                        </h2>
                        <div class="mail-tools tooltip-demo m-t-md">
                            <div class="btn-group float-right">
                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <h2>
                            <h3 class="font-weight-">Import Test Results Data / Csv / Excel</h3>
                        </h2>
                        <div class="mail-tools tooltip-demo m-t-md">
                            <div class="btn-group float-right">
