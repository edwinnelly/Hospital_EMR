                ...
                <div class="col-lg-8 animated fadeInRight">
                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            ...
                            <form method="get" action="customise_results.php">

                                <div class="form-group">

                                    <input type="hidden" name="fid" value="<?= base64_encode($get_asset_id);  ?>">
                                    <input type="hidden" name="fis" value="<?= base64_encode($get_fis);  ?>">

                                    <label>Choose numbers of entries</label>
                                    <select name="setss" class="form-control">
                                <?php
                                $x = 1;
                                while($x <= 100) {
                                ...
                                <div class="form-group">
                                   <input type="submit" name="senders" class="btn btn-primary pull-right btn-rounded btn-outline" value="Setup Now">
                                </div>
                            </form>
                            <?php
