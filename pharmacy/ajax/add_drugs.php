    ...
    echo $dname = $add_roles->get_request('drug_name');
    ...
    $new_class = $add_roles->add_drugss($dname, $drugs_class, $drugs_supply, $qty, $rqty, $costprice, $sprice, $brand, $stock, $drugs_cates, $pdate, $exdate, $batch, $hos_key,$user_id);
