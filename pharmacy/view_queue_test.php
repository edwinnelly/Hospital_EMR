                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;"> Lab test process</h3>
...
<!--                                </button>-->
                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            <h4 class="font-weight- p-1" style="text-transform: capitalize">
                                <?=  $aptients_edit->patient_name;   ?> current lab test profile
                            </h4>
                        <table class="table table-hover table-mail dataTables-example">
                            ...
                            foreach ($lab_list_dpt as $key => $values) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><?php  $pays =$values->payment; if($pays=='paid'){echo "<span class='text-success font-weight-bold'><span class='fa fa-check'></span></span>";
                                    }else{ echo "<span class='text-danger font-weight-bold'>Unpaid</span>";}  ?></td>
                                    ...
                                    <td><?php  $statusa =  $values->status; if($statusa=='Processing'){
                                        echo '<span class="text-danger font-weight-bold">Processing</span>';
                                            ...
                                            echo '<span class="text-info font-weight-bold"> Requested</span>';
                                    ...
                                    <td>
                                        ...
                                        <?php
                                         ...
                                         if($statusa=='paid'){
                                             echo "<button class='font-weight-bold bbn btn btn-primary btn-rounded btn-outline' data-id='$values->id' data-user='$values->patients_id' data-toggle='tooltip' data-placement='top' title='The lab test samples will be sent to department!'>Send Request </button>";

                                        }elseif($statusa =='approved'){ echo "<span class='text-danger font-weight-bold'>Final Stage</span>";

                                        }elseif($statusa=='pending'){
                                            echo "<span class='text-danger font-weight-bold'>Awaiting Result / Approval</span>";
                                        }elseif($statusa=='Processing'){
                                             echo "<span class='text-danger font-weight-bold'>unavailable
</span>";
                                         }
                                         ?>
                                    </td>
    ...
    $(document).ready(function () {
        ...
        $(".bbn").click(function () {
            ...
            if(host_fib=== ''){
                ...
                $.ajax({
                    url: "ajax/update_lab_request.php",
                    method: "GET",
                    data: {
                        host_fib: host_fib,users:users
                    },
                    success: function (data) {
                        swal("Good job!", "Requested test created and sent to department!", "success");
                        setTimeout(
                            function () {
                                location.reload();
                            }, 3000);
