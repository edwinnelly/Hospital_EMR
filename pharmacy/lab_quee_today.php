...
$lab_list_dpt= $add_user->quee_today($hos_key);
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;">Patients Queue / Today</h3>
                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            ...
                            <a href="lab_quee.php"> <button class="font-weight-bold btn btn-danger btn-rounded pull-right btn-outline">All Entries</button></a>
