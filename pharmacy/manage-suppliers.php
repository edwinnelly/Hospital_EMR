                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Inventory/Drug Suppliers</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="user_dir.php"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item active">Inventory/Drug Suppliers</li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header p-3 d-flex">
                                ...
                                <h5>Drug Suppliers</h5>
                            </div>
                            <div class="body table-responsive">
                                <button type="submit" class=" m-2 btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal"> Add Drug Suppliers</button>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"
                                                        ...
                                                        <a class="dropdown-item" href="add-drugs.php">Edit </a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header d-block">
                        <h6 class="title font-weight-bold" id="defaultModalLabel">Add New Supplier</h6>
                    </div>
                        ...
                        <form id="postcatdel" method="post">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Suppliers Name</label>
                                    <input type="text" placeholder="Drug Suppliers Name" class="form-control" name="catname"
                                        id="catname" required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Phone Number</label>
                                    <input type="text" placeholder="Phone" class="form-control" name="catname"
                                        id="catname" required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Address</label>
                                    <input type="text" placeholder="Address" class="form-control" name="catname"
                                        id="catname" required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Email(Optional)</label>
                                    <input type="text" placeholder="Email" class="form-control" name="catname"
                                        id="catname" required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                            </div>
