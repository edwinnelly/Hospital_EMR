...
$assets_list_n= $add_user->hospital_list_department($hos_key);
?>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <table class="table table-hover table-mail dataTables-example">
                            ...
                            foreach ($assets_list_n as $key => $values) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><?php   $hod = $values->hod_id;$fn = $values->fn;$ln = $values->ln; if($hod==0){echo 'Unassigned';}else{echo $fn ." ". $ln;} ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="edit_department.php?aset=<?=  base64_encode($values->id);  ?>" class="dropdown-item font-weight-bold edit_asset" >Edit Tax</a></li>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_dpt").click(function () {
            ...
            if(department=== ''){
                swal("Almost there!", "Please enter department name!", "info");
            }else{
                $.ajax({
        ...
        $(".del_dpt").click(function () {
            ...
            $.ajax({
                url: "ajax/d_department.php",
                method: "GET",
                data: {
                    host_fib: host_fib,
                },
                success: function (data) {
                    swal("Good job!", "This Department Has Been Removed", "success");
                    setTimeout(
                        function () {
                            location.reload();
                        }, 3000);
    ...
    <div class="modal-dialog">
        <div class="modal-content animated flipInY">
            <div class="modal-header">
                ...
                <p class="modal-title">Create Department</p>
                <small class="font-bold">You can add and assign department.</small>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary font-weight-bold btn-rounded" id="add_dpt">Create Department</button>
            </div>
        </div>
    </div>
</div>
