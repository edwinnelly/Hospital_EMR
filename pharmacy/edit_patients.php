...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h3 class="font-weight-bold">Modify Patient's Profile</h3>
                <ol class="breadcrumb">
                ...
                <div class="col-lg-10">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5 class="font-weight-bold">Edit Patients / Profile</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group"><label>Blood Pressure</label> <input  type="text"
                                                                                         placeholder="Blood Pressure" value="<?= $aptients_edit->bp;  ?>"
                                                                                         class="form-control" id="bp"

                                >
                            </div>


                            <div class="form-group"><label>Body Temp</label> <input  type="text"
                                                                                          placeholder="Body Temp" value="<?= $aptients_edit->body_temp;  ?>"
                                                                                          class="form-control" id="body_temp"

                                >
                            </div>


                            <div class="form-group"><label>Heart Rate</label> <input  type="text"
                                                                                     placeholder="Heart Rate" value="<?= $aptients_edit->heart_rate;  ?>"
                                                                                     class="form-control" id="hrate"
                            ...
                            <div class="form-group"><label>Height</label> <input  type="text"
                                                                                      placeholder="Height " value="<?= $aptients_edit->height;  ?>"
                                                                                      class="form-control" id="height"

                                >
                            </div>

                            <div class="form-group"><label>Patient briefs</label> <input  type="text"
                                                                                      placeholder="Patient briefs" value="<?= $aptients_edit->briefs;  ?>"
                                                                                      class="form-control" id="briefs"
                                ...
                                <div class="form-group"><label>Added Date</label> <input  type="date" value="<?= $aptients_edit->added_date;  ?>" placeholder="Added date" class="form-control" id="rg_date"
                                                                                         >
                                </div>
                            <input type="hidden" value="<?= $get_asset_id;  ?>" id="pid">
                                ...
                                <div>
                                    <button class="btn btn-primary btn-rounded btn-outline float-right m-t-n-xs"
                                            type="submit" id="update_users"><strong>Update
