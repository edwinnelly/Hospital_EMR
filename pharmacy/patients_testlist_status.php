...
$add_user = new controller;
 ...
 $get_asset_status = ($add_user->get_request('status'));
$aptients_edit= $add_user->edit_patients($hos_key,$get_asset_id);

$lab_list_dpt= $add_user->quee_user_test_status($hos_key,$get_asset_id,$get_asset_status);
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;"> <?=  $aptients_edit->patient_name;   ?></h3>
