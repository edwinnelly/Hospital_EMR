...
$assets_list_n= $add_user->bed_list($hos_key);
            ...
            <div class="row">
                ...
                <div class="col-lg-10 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <h2>
                            <h3 class="font-weight-bold">Hospital Bed Category</h3>
                        </h2>
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <button class="font-weight-bold btn btn-primary btn-rounded pull-right" data-toggle="modal"
                                    data-target="#myModal2">Add Category
                            </button>
                            <a href="beds.php"> <button class="font-weight-bold btn btn-primary btn-rounded">Back to Beds</button></a>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item text-danger del_asset_cat font-weight-bold" data-id="<?= $values->id;  ?>">Delete </a></li>
                                            </ul>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $("#add_s").click(function () {
            ...
            if(cat_name=== ''){
                ...
                $.ajax({
                    url: "ajax/add_bed_cat.php",
                    method: "GET",
                    data: {
                        cat_name: cat_name,host_key:host_key
                    },
                    success: function (data) {
                        swal("Good job!", "Bed Category Created!", "success");
                        setTimeout(
                            function () {
                                location.reload();
                            }, 3000);
        ...
        $(".del_asset_cat").click(function () {
            ...
            $.ajax({
                url: "ajax/d_bed_cat.php",
                method: "GET",
                data: {
                    host_fib: host_fib,
                },
                success: function (data) {
                    swal("Good job!", "This Bed Category Has Been Removed", "success");
                    setTimeout(
                        function () {
                            location.reload();
                        }, 3000);
    ...
    <div class="modal-dialog">
        <div class="modal-content animated flipInY">
            <div class="modal-header">
                ...
                <p class="modal-title">Add Bed Category</p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group"><label>Category Name</label>
                            <input type="text" id="cat_name" placeholder="Bed Category" class="form-control" id="cat_name">
                        </div>
