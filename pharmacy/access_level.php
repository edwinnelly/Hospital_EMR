                ...
                <div class="col-lg-8 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;">Change this
                                user access level</h3>
                        ...
                        <div class="ibox-content table-responsive">
                            <h4 class="font-weight-bold">
                                ...
                                <div class="form-group"><label>Access Level</label>
                                    <select class="form-control" name="assex">
                                        <option value="1">Doctor</option>
                                        <option value="2">Pharmacy</option>
                                        <option value="3">Nurse</option>
                                        <option value="4">Radiography</option>
                                        <option value="5">Lab Technician</option>
                                        <option value="6">Lab Scientist</option>
                                        <option value="7">Lab Hod</option>
                                    </select>
                                </div>
                                <input type="submit" class="font-weight-bold btn btn-primary btn-outline btn-rounded pull-right" value="Update Account" name="results">
                                </form>
                            </h4>
                            ...
                            if (isset($_POST['results'])) {
                                @$userid_le = $_POST['assex'];

                                $update_reports = $add_user->update_access($get_asset_id,$hos_key,$userid_le);
                                echo '<script>
