                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;"><img src="https://www.pngall.com/wp-content/uploads/5/Profile-Male-PNG-Free-Download.png" style="height: 60px"> <?=  $aptients_edit->patient_name;   ?></h3>
                        ...
                        <table class="table table-hover table-mail dataTables-example">
                            ...
                            foreach ($lab_list_dpt as $key => $values) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-outline btn-rounded font-weight-bold addcase" data-id="<?= $values->id;  ?>"  data-pid="<?= $values->dpt_id;  ?>" data-amount="<?= $values->amount; ?>" data-patients="<?= $get_asset_id;  ?>">Add</button>
...
<script>
    $(document).ready(function () {
        ...
        $(".addcase").click(function () {
            ...
            const host_amount = $(this).attr("data-amount");
            ...
            if(host_pid=== ''){
                ...
                $.ajax({
                    ...
                    method: "GET",
                    data: {
                        host_fib: host_fib,host_pid:host_pid,host_patients:host_patients,host_amount:host_amount
                    },
