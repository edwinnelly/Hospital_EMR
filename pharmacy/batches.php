                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Inventory/Batch Manager</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="user_dir.php"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item active">Inventory/Batch Manager</li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header p-3">
                                <a href="inventory.php" class=""><i class="fa fa-arrow-left"></i></a>
                            </div>
