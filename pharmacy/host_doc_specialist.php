            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        <h2>
                            <h3 class="font-weight-bold"> Hospital / Outpatient / Specialist <a href="add_patients">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" class="btn btn-danger m-r-sm"><?php echo $add_user->all_count_specialist($hos_key,$user_id,$specialist_id); ?></button>
                                                Total Outpatient
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-primary m-r-sm"><?php echo $add_user->all_count_outpat_seen_specialist($hos_key,$user_id,$specialist_id); ?></button>
                                                Seen
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-info m-r-sm"><?php echo $add_user->all_count_outpat_seen_specialist_open($hos_key,$user_id,$specialist_id); ?></button>
                                                Pending
                                            </td>
                                        </tr>
                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            ...
                            <table class="table table-hover table-mail dataTables-example">
                                ...
                                <?php
                                $i = 0;
                                $lab_list_dpt = $add_user->hospital_patients_sp($hos_key,$user_id,$specialist_id);
