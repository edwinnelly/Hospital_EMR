                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            <h4 class="font-weight-bold">
                                ...
                                <input type="submit" class="font-weight-bold btn btn-primary btn-outline btn-rounded pull-right" value="Assign Specialist" id="ps">
    ...
    $(document).ready(function () {
        ...
        $("#ps").click(function () {
            ...
            if (doc_id === '') {
                ...
                $.ajax({
                    url: "ajax/assign_specialist_patients.php",
                    method: "GET",
                    data: {
                        doc_id: doc_id, pid: pid
                    },
                    success: function (data) {
                        swal("Good job!", "Specialist has been assigned to this patient!", "success");
                        //redirect
                        setTimeout(
                            function () {
