            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        <h2>
                            <h3 class="font-weight-bold"> Hospital / Patients / New  <a href="add_patients"><button class="font-weight-bold btn btn-danger btn-outline btn-rounded pull-right btn-sm">Add Patients</button></a></h3>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="host_patients_folder.php?aset=<?=  base64_encode($values->id);  ?>" class="dropdown-item font-weight-bold edit_asset" >Open Folder</a></li>
