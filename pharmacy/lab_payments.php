                ...
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <h3 class="text-primary" style="text-transform: capitalize;margin-left: 20px;">Lab Bill / <?=  $aptients_edit->patient_name;   ?></h3>
                        ...
                        <table class="table table-hover table-mail dataTables-example">
                            ...
                            foreach ($lab_list_dpt as $key => $values) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <?php $statusx = $values->status;   ?>


                                    <td>
                                        <?php
                                        if($statusx == 'paid' or $statusx == 'pending' or $statusx == 'completed'){
                                            echo "<span class='fa fa-check'></span>";

                                        }else{
                                            if($statusx == 'Processing'){
                                                echo "<button class='font-weight-bold approves btn btn-success btn-outline btn-rounded' data-userid='$values->patients_id' data-id='$values->id'>Approve</button>";
...
<script>
    $(document).ready(function () {
        ...
        $(".approves").click(function () {
            ...
            const case_id = $(this).attr("data-id");
            ...
            if(userid=== ''){
                ...
                $.ajax({
                    url: "ajax/update_lab_payments.php",
                    method: "GET",
                    data: {
                        case_id: case_id,userid:userid
                    },
                    success: function (data) {

                        swal("Good job!", "Lab Test Payment Approved!", "success");
                        setTimeout(
                            function () {
                                location.reload();
                            }, 3000);
