                                ...
                                <div class="mb-4">
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"
                                            ...
                                            <a class="dropdown-item" href="add-drugs.php">Add Drugs </a>
                                            <a class="dropdown-item" href="drug-class.php">Manage Drug Class</a>
                                            <a class="dropdown-item" href="#">Manage Brand</a>
                                            <a class="dropdown-item" href="batches.php">Manage Batches</a>
                                            <a class="dropdown-item" href="manage-suppliers.php">Manage Suppliers</a>
                                            <a class="dropdown-item" href="#">Manage Set Up</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td class="">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"
                                                        x-placement="top-start"
                                                        style="position: absolute; transform: translate3d(0px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                        <a class="dropdown-item" href="edit-inventory.php">Edit </a>
