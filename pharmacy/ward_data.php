...
<head>
    ...
    <title>Ward data | Controls</title>
            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        <h2>
                            <h3 class="font-weight-bold"> Hospital / Ward / New  <a href="add_patients"><button class="font-weight-bold btn btn-danger btn-outline btn-rounded pull-right btn-sm">My InPatients</button></a>


                                <a href="add_patients"><button class="font-weight-bold btn btn-danger btn-outline btn-rounded pull-right btn-sm">All InPatients</button></a>

                                <a href="ward_data.php"><button class="font-weight-bold btn btn-danger btn-outline btn-rounded pull-right btn-sm">Ward</button></a>
                            </h3>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Scan Case Note</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Alarm</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Vitals</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Input Output Chart</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Early Warning Score</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Pain Score</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Folder EMR</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Drug Administration</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Lab Profile</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Radiographs</a></li>

                                                <li><a href="" class="dropdown-item font-weight-bold edit_asset" >Comment</a></li>
