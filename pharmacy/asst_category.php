            ...
            <div class="row">
                ...
                <div class="col-lg-10 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <h2>
                            <h3 class="font-weight-bold">Hospital Assets Category</h3>
                        </h2>
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <button class="font-weight-bold btn btn-primary btn-outline btn-rounded pull-right" data-toggle="modal"
                                    data-target="#myModal2">Add Category
                            </button>
                            <a href="app_settings.php"> <button class="font-weight-bold btn btn-outline btn-primary btn-rounded">Back to assets</button></a>
                        ...
                        <table class="table table-hover table-mail dataTables-example">
                            ...
                            foreach ($assets_list_n as $key => $values) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-danger btn-sm dropdown-toggle font-weight-bold btn-outline btn-rounded">Action </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-outline font-weight-bold btn-rounded add_asset_cat"  id="add_s">Save category</button>
            </div>
        </div>
    </div>
</div>
