            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight">
                    <div class="mail-box-header">
                        <h2>
                            <h3 class="font-weight-bold"> Hospital / Outpatient / All Queue <a href="host_outpatient.php">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" class="btn btn-danger m-r-sm"><?php echo $add_user->all_count_outpatall($hos_key); ?></button>
                                                Total Outpatient
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-primary m-r-sm"><?php echo $add_user->all_count_outpat_seen_all($hos_key,$user_id); ?></button>
                                                Seen
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-info m-r-sm"><?php echo $add_user->all_count_outpat_pending_all($hos_key,$user_id); ?></button>
                                                Pending
                                            </td>
                                        </tr>
                    ...
                    <div class="mail-box">
                        <div class="ibox-content table-responsive">
                            ...
                            <table class="table table-hover table-mail dataTables-example">
                                ...
                                <?php
                                $i = 0;
                                $lab_list_dpt = $add_user->hospital_patients_qall($hos_key);
