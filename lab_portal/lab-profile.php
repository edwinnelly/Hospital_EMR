                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Lab Profile</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="user_dir.php"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item active">Lab Profile</li>
                            </ul>
                        </div>
                                        ...
                                        <div class="col-lg-7 col-md-12">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="mt-2 ml-3">
                                                        ...
                                                        <button class="btn btn-success btn-sm" data-toggle="modal"
                                                            data-target="#exampleModal">Add Lab Test</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card mt-4 pl-4">
                                                <div class="timeline-item green">
                                                    ...
                                                    <h5 >Lab Test Title</h5>
                                                    <span><a href="javascript:void(0);">Elisse Joson</a>
                                                        Neurologist</span>
                                                    <p class="mt-4">Result Status</p>
                                                    <div class="msg">
                                                        ...
                                                        <div class="d-flex">
                                                            <button class="btn btn-success btn-sm">View Result</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
