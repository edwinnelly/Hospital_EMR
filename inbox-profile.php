    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="page-profile2.html#menu">Menu</a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="page-profile2.html#Chat"><i class="icon-book-open"></i></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="page-profile2.html#setting"><i class="icon-settings"></i></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="page-profile2.html#question"><i class="icon-question"></i></a></li>
            </ul>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">
                            <li>
                                <a href="page-profile2.html#Dashboard" class="has-arrow"><i class="icon-home"></i> <span>Dashboard</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#App" class="has-arrow"><i class="icon-grid"></i> <span>App</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#FileManager" class="has-arrow"><i class="icon-folder"></i> <span>File Manager</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#Blog" class="has-arrow"><i class="icon-globe"></i> <span>Blog</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#uiElements" class="has-arrow"><i class="icon-diamond"></i> <span>UI Elements</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#Widgets" class="has-arrow"><i class="icon-puzzle"></i> <span>Widgets</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#Authentication" class="has-arrow"><i class="icon-lock"></i> <span>Authentication</span></a>
                                <ul>
                            ...
                            <li class="active">
                                <a href="page-profile2.html#Pages" class="has-arrow"><i class="icon-docs"></i> <span>Pages</span></a>
                                <ul>
                                    <li><a href="page-blank.html">Blank Page</a> </li>
                                    <li><a href="page-profile.html">Profile <span class="badge badge-default float-right">v1</span></a></li>
                                    <li class="active"><a href="page-profile2.html">Profile <span class="badge badge-warning float-right">v2</span></a></li>
                            ...
                            <li>
                                <a href="page-profile2.html#forms" class="has-arrow"><i class="icon-pencil"></i> <span>Forms</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#Tables" class="has-arrow"><i class="icon-tag"></i> <span>Tables</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#charts" class="has-arrow"><i class="icon-bar-chart"></i> <span>Charts</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#Maps" class="has-arrow"><i class="icon-map"></i> <span>Maps</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="page-profile2.html#menu-level-1" class="has-arrow"><i class="icon-tag"></i> <span>Menu Level 1</span></a>
                                <ul>
                                    <li>
                                        <a href="page-profile2.html#menu-level-2" class="has-arrow">Menu Level 2</a>
                                        <ul>
                                            <li><a href="page-profile2.html#">Link 1</a></li>
                                            <li><a href="page-profile2.html#">Link 2</a></li>
                                            <li><a href="page-profile2.html#">Link 3</a></li>
                                            <li><a href="page-profile2.html#">Link 4</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1923731.7533500232!2d-120.39098936853455!3d37.63767091877441!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021:0x4a501367f076adff!2sSan+Francisco,+CA,+USA!5e0!3m2!1sen!2sin!4v1522391841133" width="100%" height="150" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                            <hr>
                            <small class="text-muted">Email address: </small>
                            <p><a href="../../../../cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="fc91959f949d9990bc9b919d9590d29f9391">[email&#160;protected]</a></p>
                            <hr>
                    ...
                    <div class="card">
                        <div class="body">
                            <ul class="nav nav-tabs-new">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="page-profile2.html#Overview">Overview</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="page-profile2.html#Settings">Settings</a></li>
                            </ul>
                        </div>
                    </div>
