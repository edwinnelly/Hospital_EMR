...
<html lang="en">
<head>
    <title>:: Lucid :: Contact List</title>
    <meta charset="utf-8">
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="app-chat.html#menu">Menu</a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="app-chat.html#Chat"><i class="icon-book-open"></i></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="app-chat.html#setting"><i class="icon-settings"></i></a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="app-chat.html#question"><i class="icon-question"></i></a></li>
            </ul>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">
                            <li>
                                <a href="app-chat.html#Dashboard" class="has-arrow"><i class="icon-home"></i> <span>Dashboard</span></a>
                                <ul>
                            ...
                            <li class="active">
                                <a href="app-chat.html#App" class="has-arrow"><i class="icon-grid"></i> <span>App</span></a>
                                <ul>
                                    <li><a href="app-inbox.html">Inbox</a></li>
                                    <li class="active"><a href="app-chat.html">Chat</a></li>
                            ...
                            <li>
                                <a href="app-chat.html#FileManager" class="has-arrow"><i class="icon-folder"></i> <span>File Manager</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Blog" class="has-arrow"><i class="icon-globe"></i> <span>Blog</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#uiElements" class="has-arrow"><i class="icon-diamond"></i> <span>UI Elements</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Widgets" class="has-arrow"><i class="icon-puzzle"></i> <span>Widgets</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Authentication" class="has-arrow"><i class="icon-lock"></i> <span>Authentication</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Pages" class="has-arrow"><i class="icon-docs"></i> <span>Pages</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#forms" class="has-arrow"><i class="icon-pencil"></i> <span>Forms</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Tables" class="has-arrow"><i class="icon-tag"></i> <span>Tables</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#charts" class="has-arrow"><i class="icon-bar-chart"></i> <span>Charts</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#Maps" class="has-arrow"><i class="icon-map"></i> <span>Maps</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="app-chat.html#menu-level-1" class="has-arrow"><i class="icon-tag"></i> <span>Menu Level 1</span></a>
                                <ul>
                                    <li>
                                        <a href="app-chat.html#menu-level-2" class="has-arrow">Menu Level 2</a>
                                        <ul>
                                            <li><a href="app-chat.html#">Link 1</a></li>
                                            <li><a href="app-chat.html#">Link 2</a></li>
                                            <li><a href="app-chat.html#">Link 3</a></li>
                                            <li><a href="app-chat.html#">Link 4</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><a href="../../../../cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="90fdf9f3f8f1f5fcd0f7fdf1f9fcbef3fffd">[email&#160;protected]</a></p>
