                                        ...
                                        <div class="col-lg-7 col-md-12">
                                                    ...
                                                    <div>
                                                        ...
                                                        <table class="table small m-b-xs">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <strong>Blood Pressure</strong> - <strong
                                                                            class="text-danger">0/0</strong>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <strong>Sex</strong> - <strong
                                                                            class="text-danger">M</strong>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <a href="add-encounter-note.php"><button
                                                                class="btn btn-success btn-sm">Add Enounter
                                                                Note</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card mt-4 pl-4">
                                                <div class="timeline-item green">
                                                    <span class="">Encounters ID</span>
                                                    <div class="msg">
                                                        <div class="mb-2">
                                                            <h5>Compliants</h5>
                                                            <p>I'm speaking with myself, number one, because I have a
                                                                very
                                                                good brain and I've said a lot of things. I write the
                                                                best
                                                                placeholder text, and I'm the biggest developer on the
                                                                web
                                                        ...
                                                        <div class="mb-2">
                                                            <h5>Diagnosis</h5>
                                                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus, fugit?
                                                            </p>
                                                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header d-block">
                        <h6 class="title font-weight-bold" id="defaultModalLabel">Add Encounter Note</h6>
                    ...
                    <div class="modal-body">
                        <form id="postcatdel" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="exampleFormControlTextarea2">Edit Note</label>
                                    <textarea class="form-control trumbowyg-demo" id="exampleFormControlTextarea2"
                                        rows="1"></textarea>
                                </div>
                            </div>
                    </div>
