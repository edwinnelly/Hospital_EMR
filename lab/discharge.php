                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Discharge Summary Folder</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="user_dir.php"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item active">Discharge Summary Folder</li>
                            </ul>
                        </div>
                            ...
                            <div class="mail-inbox">
                                ...
                                <div class="mail-right">
                                    <div class="header d-flex align-center">
                                        <h2>Discharge Summary Folder</h2>
                                    </div>
                                    <div class="row clearfix">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="mt-2 ml-3">
                                                        ...
                                                        <button class="btn btn-success btn-sm" data-toggle="modal"
                                                            data-target="#exampleModal">Add Discharge Note</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card mt-4 pl-4">
                                                <div class="timeline-item green">
                                                    <span class="">Discharge Report ID</span>
                                                    <h5>Discharge Summary Title</h5>
                                                    <div class="msg">
