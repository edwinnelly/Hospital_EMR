...
<body class="theme-cyan">
   ...
   ?>
                                            ...
                                            <div class="card mt-4 pb-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="mt-2 ml-3">
                                                        ...
                                                        <button class="btn btn-success btn-sm"  data-toggle="modal" data-target="#exampleModal">Add Appointment</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card mt-4 pl-4">
                                                <div class="timeline-item green">
                                                    <span class="mb-2">Appointmemnt ID</span>
                                                    <h5>Appointment Title</h5>
                                                    <span><a href="javascript:void(0);">Elisse Joson</a>
                                                        Neurologist</span>
                                                    <div class="msg">
                                                        <h6>Description</h6>
                                                        ...
                                                        <div class="d-flex">
                                                            <button class="btn btn-danger btn-sm p-2 mr-2"> X</button>
        ...
        <!-- modal start -->
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="title font-weight-bold" id="defaultModalLabel">Add Appointment</h6>
                    </div>
                        ...
                        <form id="postcatdel" method="post">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Appointmemnt Title</label>
                                    <input type="text" placeholder="Appointment Title" class=" form-control"
                                        name="catname" id="catname"  required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3">
                                    <label for="" class="fw-bold mb-2">Appointmemnt Description</label>
                                    <input type="text" placeholder="Appointment Description" class="form-control"
                                        name="catname" id="catname"  required>
                                    <input type="hidden" name="cpid" id="cpids">
                                </div>
                                <div class="col-sm-12 col-md-12">
                                    <label for="" class="fw-bold mb-2">Appointmemnt Date/Time</label>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-primary font-weight-bold" id=""
                            value="Add">
